...
def plotPsych(result,
    ...
    if plotData:
        ...
        for i in range(len(xData)):
            plt.plot(xData[i], yData[i], '.', ms=markerSize[i], markeredgecolor=dataColor, markerfacecolor='None', clip_on=False)
    ...
    plt.plot(x,     fitValues,           c=lineColor, lw=lineWidth, clip_on=False, label=legendLabel)
